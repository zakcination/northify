...
public class TeamElementSubsystem {
    OpenCvCamera camera;
    org.firstinspires.ftc.teamcode.subsystems.TeamElementDetection.Pipeline.SplitAveragePipeline splitAveragePipeline;
    int camW = 800;
    int camH = 448;
    ...
    public TeamElementSubsystem(HardwareMap hardwareMap){
        ...
        splitAveragePipeline = new org.firstinspires.ftc.teamcode.subsystems.TeamElementDetection.Pipeline.SplitAveragePipeline();
